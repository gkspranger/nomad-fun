...
```
nomad-pack run hello-world --var message="Hola Mundo!"
```
...
balance the Consul service `hello-world-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the hello-world
  application
